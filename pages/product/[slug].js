...
function Post({ addToCart, product, variants, error, buyNow }) {
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex">
                ...
                {product.availableQty > 0 && (
                  <button
                    ...
                    className="disabled:bg-indigo-100 flex ml-4 text-white bg-indigo-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-indigo-600 rounded"
                  >
                    Buy Now
                  </button>
                )}
              ...
              {service && service != null && (
                <div className="text-green-700 text-sm mt-3">
                  Yeah!!! We&rsquo;ll Deliver to this Pin Code.
                </div>
              )}
            </div>
          </div>
